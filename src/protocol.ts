 ...
 *
 * This file is the public source of truth for messages sent between a prototype and its host.
 */
...
/** Per-prototype key-value persistence, brokered by the shell.
...
/** A provider-neutral managed AI request. It crosses the shell because the sandbox has no
 * network access; Prototir owns provider credentials, routing, safety, and metering. */
...
/** Reply to an AiMessage with the same id and a machine-readable error on failure. */
